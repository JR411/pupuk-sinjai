...
<head>
    ...
    <title>Pupuk Sinjai | Petani</title>
                ...
                <div class="offcanvas-body d-xl-none">
                    <ul class="nav flex-column mb-auto">
                        <li><a href="/informasi-pupuk" class="nav-link px-2 text-white">Informasi
                                Pupuk</a></li>
                        <li><a href="/petani"
                                class="nav-link px-2 {{ Request::is('petani') || Request::is('petani/proses*') ? 'active' : 'text-white' }}">Pesan
                                Pupuk</a></li>
                        <li><a href="/petani/profil-distributor"
                                class="nav-link px-2 {{ Request::is('petani/profil*') ? 'active' : 'text-white' }}">Profil
                                Distributor</a></li>
                        <li><a href="/petani/riwayat-pesanan"
                                class="nav-link px-2 {{ Request::is('petani/riwayat*') ? 'active' : 'text-white' }}">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-xl-start">
                    ...
                    <ul class="d-none d-xl-flex nav nav-atas ms-4 mt-5">
                        <li><a href="/informasi-pupuk" class="nav-link px-2 text-white">Informasi
                                Pupuk</a></li>
                        <li><a href="/petani"
                                class="nav-link border-start px-2 {{ Request::is('petani') || Request::is('petani/proses*') ? 'active' : 'text-white' }}">Pesan
                                Pupuk</a></li>
                        <li><a href="/petani/profil-distributor"
                                class="nav-link border-start px-2 {{ Request::is('petani/profil*') ? 'active' : 'text-white' }}">Profil
                                Distributor</a></li>
                        <li><a href="/petani/riwayat-pesanan"
                                class="nav-link border-start px-2 {{ Request::is('petani/riwayat*') ? 'active' : 'text-white' }}">
                                Riwayat Pesanan</a></li>
                    </ul>
